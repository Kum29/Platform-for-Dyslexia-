...
# ================= ROUTER REGISTRATION =================
# We wrap these in a try-except block so the server doesn't crash 
# if a specific backend file is missing or contains errors.
...
if __name__ == "__main__":
    # Ensure this file is named 'main.py' for this line to work
